    ...
    <section className="space-y-6">
      <div className="max-w-2xl">
        ...
        <h2 className="mt-3 text-3xl font-semibold tracking-tight lg:text-4xl">
          Offer a familiar package section without reusing another site&apos;s pricing page.
        </h2>
      </div>
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        {pricingPlans.map((plan) => (
          ...
          >
            ...
            <Link href={cclSignUpHref} className={`${plan.ctaClass} mt-8 w-full justify-center`}>
              Choose {plan.name}
            </Link>
          </article>
        ))}
